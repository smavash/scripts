...
bde_system_event_10046.sql - SQL Trace any transaction with Event 10046 8.1-9.0
 ...
 --------
    ...
    Turns EVENT 10046 LEVEL 12 for all new sessions (system wide).

    This script is used to turn SQL Trace ON with LEVEL 12 for any Concurrent
...
PROMPT by using EVENT 10046 with LEVEL 12 (WAITS plus BIND VARIABLES).
PROMPT
PROMPT This method is used to Trace with Level 12 any Concurrent Program that
...
PROMPT
PROMPT ALL new sessions will have EVENT 10046 turned ON with LEVEL 12
PROMPT
