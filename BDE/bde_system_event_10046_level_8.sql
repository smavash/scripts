...
bde_system_event_10046.sql - SQL Trace any transaction with Event 10046 8.1-9.0
 ...
 --------
    ...
    Turns EVENT 10046 LEVEL 8 for all new sessions (system wide).

    This script is used to turn SQL Trace ON with LEVEL 8 for any Concurrent
 ...
 3. Execute from SQL*Plus using APPS account:
    ...
    SQL> START bde_session_event_10046_level_8.sql;
 ...
 3. Event 10046 Level 12 reports Bind Variables values on raw SQL Trace.
