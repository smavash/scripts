/*$Header: bde_request.sql 11.5 187504.1 2002/09/03             csierra bde $*/
...
bde_request.sql - Process and Session info for one Concurrent Request (11.5)
 ...
 1. Copy this whole Note into a text file and name it bde_request.sql.

 2. Open a SQL*Plus session connecting as APPS and execute:

    SQL> START bde_request.sql <request_id>


 Program Notes
 -------------

 1. Always download latest version from Metalink (Note:187504.1), or ftp from
 ...
 2. This script has been tested up to Oracle Apps 11.5.6 with Oracle 8.1.7.
 ...
 ------
    ...
    Abstract: bde_request.sql - Process/Session info for 1 Conc Request (11.5)
    Author: Carlos Sierra
    Date: 03-SEP-02
    Description: Process and Session info for one Concurrent Request (11.5)
    EMail: carlos.sierra@oracle.com
    Internal_Only: N
    Keywords: CoE sqltuning coescripts appsperf appssqltuning BDE
    Metalink_Note: 187504.1
    New_Win: Y
    Product: SQL*Plus script
    Version: 11.5 2002/09/03
    Download: bde_request.zip
