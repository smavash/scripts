...
/*$Header: bde_session_locks.sql 8.1-9.2  200590.1 2002/11/21   csierra coe $*/
SET term off;
/*=============================================================================

bde_session_locks.sql - Locks for given Session ID (8.1-9.2)
 ...
 1. Always download latest version from Metalink (Note:200590.1)
...
VARIABLE v_saddr           VARCHAR2(32);
VARIABLE v_sid             NUMBER;
VARIABLE v_serial#         NUMBER;
VARIABLE v_paddr           VARCHAR2(32);
VARIABLE v_command         NUMBER;
VARIABLE v_taddr           VARCHAR2(32);
VARIABLE v_lockwait        VARCHAR2(32);
VARIABLE v_prev_sql_addr   VARCHAR2(32);
VARIABLE v_prev_hash_value NUMBER;
VARIABLE v_sql_address     VARCHAR2(32);
...
VARIABLE v_latchwait       VARCHAR2(32);
VARIABLE v_latchspin       VARCHAR2(32);

VARIABLE v_object_owner    VARCHAR2(30);
VARIABLE v_object_name     VARCHAR2(128);

VARIABLE v_blocker_sid     NUMBER;
VARIABLE v_blocker_paddr   VARCHAR2(32);
VARIABLE v_blocker_taddr   VARCHAR2(32);
