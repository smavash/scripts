...
ARC_DEST=/dwh/arch/BIDWHPROD
ARC_DEST_GZIP=/dwh/arch/BIDWHPROD/bk_gzip

ARC_KEEP_DAYS=2  #-- Keep Archive log files for the last three days
...
#-- 3 -- Delete Old Files
#--------------------------------------------
find $ARC_DEST_GZIP -type f -mtime +$ARC_KEEP_DAYS -exec echo Removing {} ... \; | tee -a $LOGFILE
find $ARC_DEST_GZIP  -type f -mtime +$ARC_KEEP_DAYS -exec rm -f {} \;
